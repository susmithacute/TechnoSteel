                        ...
                        <div class="tile-body">
                            <div class="table-responsive">
                                <table class="table table-custom" id="editable-usage">
                                    <thead>
                                        <tr><td><button id="gen_sif"> SIF</button></td></tr>
                                        <tr>
                                            <td style="width:90px;">Employer ID</td>
                                            <td style="width:90px;">File Creation Date</td>
                                            <td style="width:90px;">File Creation Time</td>
                                            <td style="width:90px;">Payer EID</td>
                                            <td style="width:90px;">Payer QID</td>
                                            <td style="width:90px;">Payer Bank Short Name</td>
                                            <td style="width:10px;">Payer IBAN</td>
                                            <td style="width:10px;">Salary Year and Month</td>
                                            <td style="width:10px;">Total Salaries</td>
                                            <td style="width:10px;">Total Records</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td style="width:90px;">Record Sequence</td>
                                            <td style="width:90px;">Employee QID</td>
                                            <td style="width:90px;">Employee Visa ID</td>
                                            <td style="width:90px;">Employee Name</td>
                                            <td style="width:90px;">Employee Bank Short Name</td>
                                            <td style="width:90px;">Employee Account</td>
                                            <td style="width:90px;">Salary Frequency</td>
                                            <td style="width:10px;">Working Days</td>
                                            <td style="width:10px;">Net Salary</td>
                                            <td style="width:10px;">Basic Salary</td>
                                            <td style="width:10px;">Extra Hours</td>
                                            <td style="width:10px;">Extra Income</td>
                                            <td style="width:20px;">Deductions</td>
                                            <td style="width:90px;">Payment Type</td>
                                            <td style="width:90px;">Notes/Comments</td>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<script type="text/javascript">
    $('#gen_sif').click(function () {
        var salary = $('#total_salary').html();
        var records = $('#total_records').html();
        $.ajax({
            url: "sif_excel.php",
            method: "POST",
            data: {salary: salary, records: records},
            success: function () {

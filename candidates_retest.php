    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p id="retest_status" style="color:#080"></p>
...
<script>
    ...
    var retest_can = $('#hid_del').val();
    $.ajax({
    url: "candidate_list_process.php",
            type: "POST",
            data: {hiddn: retest_can},
            success: function (data) {
            $('#retest_status').html(data);
            location.href = "candidates_retest.php";
            }
    });
    });
</script>

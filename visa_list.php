            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="companylist.php">Process Visa</a>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Visa </strong> List</h1>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <select class="form-control" name="vehicle_assigned_employee" id="vehicle_assigned_employee" required="">
                    ...
                    <option  value="" selected>Applied</option>
					<option  value="" selected>Not Applied</option>
            ...
            "columns": [
...

                {
                    ...
                    "render": function (data,type,full,meta) {
                        ...
                        return '<a  class="btn btn-xs btn-default mr-5" onclick="delete_id(' + data + ','+full.emp_count+')"  data-toggle="modal" data-target="#splash1" data-options="splash-ef-3"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ','+full.emp_count+')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';

...
AND sm_employee.employee_sponsorfee_status = 'Cancel'");
if (count($resFet)) {
...
<section id="content">
    <div class="page page-shop-products">
        <div class="pageheader">
            <h2>Sponsorship Fee Listhai<span></span></h2>
            <div class="page-bar">
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {archive_emp: pass_val},
            success: function (data) {
                window.location = "archive_employee_sponsorfee.php";
            }
        });
    });

...
$head = "";
$head1 = "";
$sub1 = "accounts_report_advance_pending";
$tab1 = "";
// $page="Accounting";
...
$resFet = $db->selectQuery("SELECT CONCAT(sm_employee.employee_firstname,' ',sm_employee.employee_middlename,' ',sm_employee.employee_lastname)as fullname, sm_employee.employee_salary,sm_employee.employee_id,sm_salary_advance.advance_amount,sm_salary_advance.advance_payment_status FROM sm_employee INNER JOIN sm_salary_advance ON sm_employee.employee_id=sm_salary_advance.employee_id WHERE`advance_payment_status`='Not Paid'");
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Advance</strong>Pending List</h1>
                            <ul class="controls">
                                <li class="dropdown">
...
<script>
    function printDiv(divName) {
        ...
        window.print();
        location.href = "accounts_report_employee.php";

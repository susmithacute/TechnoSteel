                                                ...
                                                if (isset($_REQUEST['can_id'])) {
                                                    ...
                                                    if (count($appli)) {
                                                        ...
                                                        //for ($qi = 0; $qi < count($appli); $qi++) {
															...
															<?php $select_interview = $db->selectQuery("SELECT `interview_name` FROM `sm_interview` WHERE `interview_id`='".$appli[0]['interview_id']."'");
															  if (count($select_interview)) {  ?>
															<div class=" col-sm-6">
										...
										<div class="row">
											<div class="col-md-3">
                                                ...
                                                if (isset($_REQUEST['can_id'])) {
                                                    ...
                                                    $select_pass = $db->selectQuery("SELECT * FROM `sm_candidate_files` WHERE `candidate_id`='$candidate_id' AND `file_name`='Passport_Documents' AND `file_status` = 1");
													
													$Imgs = '';
													if($display_name == 'agent')
													{
														$Imgs = str_replace("../","",$select_pass[0]['file_path']);
													} else {
														$Imgs = $select_pass[0]['file_path'];
													}

                                                    if (count($select_pass) && file_exists($Imgs)) {
                                                    ...
                                                    $select_exp = $db->selectQuery("SELECT * FROM `sm_candidate_files` WHERE `candidate_id`='$candidate_id' AND `file_name`='Experience_Certificates' AND `file_status` = 1");
													
													$Imgs = '';
													if($display_name == 'agent')
													{
														$Imgs = str_replace("../","",$select_exp[0]['file_path']);
													} else {
														$Imgs = $select_exp[0]['file_path'];
													}

                                                    if (count($select_exp) && file_exists($Imgs)) {
                                                    ...
                                                    $select_res = $db->selectQuery("SELECT * FROM `sm_candidate_files` WHERE `candidate_id`='$candidate_id' AND `file_name`='Resume' AND `file_status` = 1");
													
													$Imgs = '';
													if($display_name == 'agent')
													{
														$Imgs = str_replace("../","",$select_res[0]['file_path']);
													} else {
														$Imgs = $select_res[0]['file_path'];
													}

                                                    if (count($select_res) && file_exists($Imgs)) {
                                                    ...
                                                    $select_IDC = $db->selectQuery("SELECT * FROM `sm_candidate_files` WHERE `candidate_id`='$candidate_id' AND `file_name`='ID_Card' AND `file_status` = 1");
													
													$Imgs = '';
													if($display_name == 'agent')
													{
														$Imgs = str_replace("../","",$select_IDC[0]['file_path']);
													} else {
														$Imgs = $select_IDC[0]['file_path'];
													}

                                                    if (count($select_IDC) && file_exists($Imgs)) {
                                                    ...
                                                    $select_Dl = $db->selectQuery("SELECT * FROM `sm_candidate_files` WHERE `candidate_id`='$candidate_id' AND `file_name`='Driving_License' AND `file_status` = 1");
													
													$Imgs = '';
													if($display_name == 'agent')
													{
														$Imgs = str_replace("../","",$select_Dl[0]['file_path']);
													} else {
														$Imgs = $select_Dl[0]['file_path'];
													}

                                                    if (count($select_Dl) && file_exists($Imgs)) {
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <span class="btn btn-success fileinput-button"> <i class="glyphicon glyphicon-plus"></i>
																...
																<input type="hidden" name="emp_docs[6][document_title]"
																   value="Candidate_Contract" readonly=""
																   class="form-control addt_text"
																   style="background-color: #fff; cursor: default;">

      ...
      var t=  $('#products-list').DataTable({
            ...
            "columns": [
                ...
                {"data": "datediff"},
                {
                    ...
                    "data": "datediff",
                    "render": function (data, type, full, meta) {
					 return '<a href="accounts_employee_travel_ticket_details.php?employee_id='+ full.employee_id+ '&emp_leave='+data+'" class="btn btn-xs btn-blue"><i class="fa fa-plus"></i>Apply</a>';
                    }}
            ],
            "aoColumnDefs": [

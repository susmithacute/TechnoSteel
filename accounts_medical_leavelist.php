...
<section id="content">
    ...
    <div class="page page-shop-products">
      ...
      <div class="pageheader">
            ...
            <h2>Medical Leave <span> : <?php echo $fullname; ?></span></h2> 
            ...
            "columns": [
				...
				
				{
					...
					"render": function (data) {
                        return '<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-red" data-toggle="modal" data-target="#splashdel" data-options="splash-ef-3">Delete</a><a onclick="edit_id(' + data + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i></i>Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-default mr-5" data-toggle="modal" data-target="#uploadsplash" data-options="splash-ef-3">Upload</a>&nbsp;&nbsp;<a href="accounts_emp_medical_doc_gallery.php?uid=<?php echo $_GET['uid'] ?>"  class="btn btn-xs btn-green mr-5"  data-options="splash-ef-3"style="">View</a>';
                }}
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "accounts_medical_leavelist.php?uid="+<?php echo $uid ?>;
            }
        });
    });
	</script>
        ...
        $.ajax({
            ...
            success: function (data) {
				//alert (data);
                    ...
                    $(Succ).html("Added");
					location.href = "accounts_medical_leavelist.php?uid="+<?php echo $uid ?>;
                }
				else
				{
					 $(Succ).html("");

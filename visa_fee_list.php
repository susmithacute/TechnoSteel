...
if (count($fee_list )) {
	...
	{   
		...
		$sl=$cou+1;
	    $values['sl_id']=$sl;
        $values['visa_fee_id'] = $fee_list[$cou]['visa_fee_id'];
        $values['visa_fee_category'] = $fee_list[$cou]['visa_fee_category'];
		$values['visa_fee_type'] = $fee_list[$cou]['visa_fee_type'];
		$values['visa_fee_bank'] = $fee_list[$cou]['visa_fee_bank'];
		$values['visa_fee_company'] = $fee_list[$cou]['visa_fee_company'];
		$values['visa_fee_sponsor'] = $fee_list[$cou]['visa_fee_sponsor'];
        $coufArray["data"][] = $values;
    }
}
$fp = fopen('assets/extras/fee.json', 'w');
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Visa Fee List</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Visa Fee List</h1>
                            <ul class="controls">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
											...
											<th style="width:160px;"> Bank Fee</th>
											<th style="width:160px;"> Sponsor Fee</th>
											
											<th style="width:160px;"> Company Fee</th>
    ...
    $(window).load(function () {
        ...
        $('#products-list').DataTable({
            ...
            "columns": [
                ...
                {"data": "sl_id"},
				{"data": "visa_fee_type"},
                {"data": "visa_fee_category"},
				{"data": "visa_fee_bank"},
				{"data": "visa_fee_sponsor"},
				{"data": "visa_fee_company"},
               ...
               
                {
                    ...
                    "render": function (data) {
                        return '<a href="visa_fee_edit.php?fee_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
            ],
            "aoColumnDefs": [
...
<script fee="text/javascript">
    function delete_id(fee_id)
    {
        $.session.set('delete_seesion', fee_id);
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "visa_fee_delete.php",
            fee: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
                window.location = "visa_fee_list.php";
            }
        });
    });</script>

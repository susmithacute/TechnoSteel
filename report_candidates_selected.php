...
if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
        ...
        $values['candidate_interview_status'] = $resFet[$rC]['candidate_interview_status'];
			$candidate_interview_status =  $values['candidate_interview_status'];
		if($candidate_interview_status == "onhold")
		{
			 $values['candidate_interview_status'] = "On Hold";
		}
	if($candidate_interview_status == ""){
			$values['candidate_interview_status'] = "Pending";
		}
        $cmpArray["data"][] = $values;
    }
}
$fp = fopen('assets/extras/report_candidate_selected.json', 'w');
                                                ...
                                                $(window).load(function () {
                                                  ...
                                                  $('#products-list').DataTable({
                                                        ...
                                                        "buttons": [
                                                            {
                                                                extend: 'excelHtml5',
                                                                title: 'Yearly - Travel Booked List'
                                                            },
                                                            {
                                                                extend: 'pdfHtml5',
                                                                title: 'Yearly - Travel Booked List'
                                                        ...
                                                        "pagingType": "input",
                                                        "ajax": 'assets/extras/report_candidate_selected.json',
                                                        "order": [[0, "asc"]],
                                                        "columns": [
                                                            {"data": "sl_no"},
                                                            ...
                                                            {"data": "candidate_interview_status"}

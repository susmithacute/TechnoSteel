...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Issued Visa List <span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Issued Visa </strong> List</h1>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title custom-font">Add Entry Date</h3>
...
<script>
    ...
    $(window).load(function () {
        ...
        var t =$('#products-list').DataTable({
            ...
            "ajax": 'assets/extras/visa_issued.json',
            ...
            "columns": [
...

                {
                    ...
                    "render": function (data,type,full,meta) {
                        ...
                        return '<a  class="btn btn-xs btn-default mr-5" onclick="delete_id(' + data + ','+full.emp_count+')"  data-toggle="modal" data-target="#splash1" data-options="splash-ef-3"><i class="fa fa-plus"></i> Date</a><a onclick="delete_id(' + data + ','+full.emp_count+')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';

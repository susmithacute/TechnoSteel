...
$page = "employee";
$tab = "e_list";
$sub="employee_consolidated_list";
...
$resFet=$db->selectQuery("SELECT DISTINCT CONCAT( sm_employee.employee_firstname,  ' ', sm_employee.employee_middlename,  ' ', sm_employee.employee_lastname ) AS full_name, sm_employee.employee_designation, sm_employee.employee_employment_id,  sm_employee.employee_id, sm_employee.employee_email,sm_medical_visa_status.medical_status
FROM sm_employee
LEFT JOIN sm_medical_visa_status ON sm_employee.employee_id = sm_medical_visa_status.employee_id
WHERE sm_employee.employee_id NOT IN(SELECT employee_id FROM sm_medical_visa_status WHERE medical_status!='passed') AND sm_employee.employee_status ='1'" );
if (count($resFet)) {
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a>Employee-Consolidated List </a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Employee</strong>-consolidated list</h1>
                            <ul class="controls">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                                        ...
                                        <li>
                                            <a role="button" tabindex="0" class="tile-refresh">            <i class="fa fa-refresh"></i> Refresh
                                            </a>
                                        </li>
                                        <li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="modal-body">
                        ...
                        <select type="text" name="todo_status" id="todo_status" class="form-control">

...
$type_list = $db->selectQuery("SELECT * FROM  sm_hiring_requirment WHERE `status` = '1'  order by `id` DESC");
...
if (count($type_list )) {
	...
	{   
	   ...
	   $values['sl_id']=$id;
		...
		$values['requirement'] = $type_list[$cou]['requirement'];
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Hiring Requirement List<span></span></h2>
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Hiring Requirement List</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Hiring Requirement List</h1>
                            <ul class="controls">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
											...
											<th style="width:140px;">Total Resources</th>
												<th style="width:130px;">Date From</th>
											<th style="width:130px;">Date To</th>
                                            <th style="width:190px;" class="no-sort">Actions</th>
                                        </tr>
                                    </thead>
            ...
            "columns": [
               ...
               
                {
                    ...
                    "render": function (data) {
                         c=
						 '<a href="accounts_hiring_requirment_edit.php?type_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>&nbsp;<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>&nbsp;&nbsp;<a href="accounts_provider_details_list.php?id=' + data + '" class="btn btn-xs btn-green" data-toggle="modal"  > provider</a>';
						 return c;
                    }}
            ],
            "aoColumnDefs": [
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "hiring_worksite_delete.php",
            type: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
                window.location = "accounts_hiring_requirment_list.php";
            }
        });
    });</script>

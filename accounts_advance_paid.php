...
$resFet = $db->selectQuery("SELECT CONCAT(sm_employee.employee_firstname,' ',sm_employee.employee_middlename,' ',sm_employee.employee_lastname)as fullname, sm_employee.employee_salary,sm_employee.employee_id,sm_salary_advance.advance_amount,sm_salary_advance.advance_requested_date,sm_salary_advance.advance_status FROM sm_employee INNER JOIN sm_salary_advance ON sm_employee.employee_id=sm_salary_advance.employee_id WHERE`advance_status`='Paid'");
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Advance Paid List</strong></h1>

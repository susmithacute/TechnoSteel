                        ...
                        <div class="tile-body">
                            <div class="table-responsive">
                                <table class="table table-custom" id="editable-usage">
                                    <thead>
                                        <tr><td><button id="gen_sif" class="btn btn-activated">Generate SIF</button></td></tr>
                                        <tr>
...
<script type="text/javascript">
    $('#gen_sif').click(function () {
        ...
        $.ajax({
            url: "sif_excel.php",
            method: "POST",
            data: {salary: salary, records: records, cid: '<?php echo $company_id; ?>'},
            success: function (data) {
                location.href = "sif_download.php?name=" + data;
            }
        });
    });
</script>

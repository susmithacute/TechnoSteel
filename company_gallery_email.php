...
if (isset($_POST['imgVal'])) {
    ...
    $select_cmp_data = $db->selectQuery("SELECT * FROM `sm_company` WHERE `company_id`='$company_id'");
    if (count($select_cmp_data) > 0) {
        $company_name = $select_cmp_data[0]['company_name'];
        $message = "<table>"
                . "<tr>"
                . "<td><b>Company Name</b>: " . $company_name . "</td>"
                . "</tr>"
                . "<tr>"

...
$sub1 = "accounts_insurance_type_add";
...
<section id="content">
    ...
    <div class="page page-forms-wizard">
        ...
        <div class="pageheader">
            <h2>Add Insurance Type<span></span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Add Insurance Type</a>
                    </li>
                </ul>
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Add New Insurance Type</a></li>
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="insurance_name" id="insurance_name" class="form-control" required>
...
$('#submit_btn').click(function(){
    $('#exist_status').html('');
    var insurance_name = jQuery('#insurance_name').val();
    if(insurance_name==""){
       // $('#exist_status').html("This value is required.");
    }
    else {
        $.ajax({
            url: 'insuraance_check.php',
            type: 'POST',
            dataType: 'json',
            ...
            success: function (data) {
                ...
                if (ch2 == 1) {
                    location.href='insurance_list.php'
                }

                ...
                <div class="col-md-12">
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <ul class="controls">
							<li>
 <a href="advance_add.php" role="button" tabindex="0" class="tile-add" title="Advance Request">
            ...
            "columns": [
				...
				
				{
                    ...
                    "render": function (data, type, full, meta) {
                        return '<a href="advance_edit_profile.php?adv_id=' + full.advance_id + '" class=""><i class=""></i> ' + data + '</a>';
                    }},
                //{"data": "employee_name"},
				...
				}},
                {
                    ...
                    "render": function (data, type, full, meta)  {
						if(data==="Requested"){
                        return '<a onclick="update_id(' +full.advance_id + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-check"></i>Change</a> <a href="advance_edit.php?adv_id=' + full.advance_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>';
						}
						
						else if(data==="Approved"){
							 return '<a onclick="update_id(' + full.advance_id + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#approved_splash" data-options="splash-ef-3"><i class="fa fa-check"></i>Change</a> <a href="advance_edit.php?adv_id=' + full.advance_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>';
						}
						else if(data==="Paid"){
							 return '<a onclick="update_id(' + full.advance_id + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#approved_splash" data-options="splash-ef-3"><i class="fa fa-check"></i>Change</a> <a href="advance_edit.php?adv_id=' + full.advance_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>';
						}
						else if(data==="Not Paid"){
							 return '<a onclick="update_id(' + full.advance_id + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#pending_splash" data-options="splash-ef-3"><i class="fa fa-check"></i>Change</a> <a href="advance_edit.php?adv_id=' + full.advance_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>';
						}
						else{
							 return '<a onclick="update_id(' +full.advance_id + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-check"></i>Change</a> <a href="advance_edit.php?adv_id=' + full.advance_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a>';
						}
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = "advance_requested.php";
            }
        });
    });
</script>

<?php
$page = "accounts";
$tab = "accounts_employee_timesheet";
...
?>
	...
	function key_up_functionO(valuez){
		...
		//alert(normal);
		//alert(over1);
		var over=parseInt(over1)+parseInt(normal);
	...
	function key_up_functionH(valuez){
        ...
        calculate_hours(holiday,valuez);
...
/*function findTotalO(){
	...
	//$('#submit_normalOV').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
            window.location = "accounts_time_sheet.php?uid=<?php echo $employee_id ?>";
            }
        });
    };
	//);

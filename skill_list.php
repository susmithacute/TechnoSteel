...
$skill_list = $db->selectQuery("SELECT  `skill_id`, `skill_name`,`skill_job`,`skill_category` FROM `sm_job_skill` where `skill_status`='1' ORDER BY skill_id DESC ");
if (count($skill_list )) {
    for ($cou = 0; $cou < count($skill_list ); $cou++) 
	{
		$sl=$cou+1;
	    $values['sl_id']=$sl;
        $values['skill_id'] = $skill_list[$cou]['skill_id'];
        $values['skill_name'] = $skill_list[$cou]['skill_name'];
		$values['skill_job'] = $skill_list[$cou]['skill_job'];
		$values['skill_category'] = $skill_list[$cou]['skill_category'];
		//$values['company_status'] = $resFet[$rC]['company_status'];
        $coufArray["data"][] = $values;
    }
}
$fp = fopen('assets/extras/skill.json', 'w');
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Skill List</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Skill List</h1>
                            <ul class="controls">
...
<li>
 <a href="skill_add.php" role="button" tabindex="0" class="tile-add" title=" Add Skill">
            ...
            "columns": [
               ...
               
                {
                    ...
                    "render": function (data) {
                        return '<a href="skill_edit.php?skill_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
            ],
            "aoColumnDefs": [
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "skill_delete.php",
            type: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
                window.location = "skill_list.php";
            }
        });
    });</script>

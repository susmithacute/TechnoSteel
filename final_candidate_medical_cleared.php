...
sm_candidate.candidate_middlename,' ',sm_candidate.candidate_lastname) as fullname, sm_candidate.candidate_email,
 ...
 sm_candidate LEFT JOIN sm_candidate_application ON sm_candidate.candidate_id=sm_candidate_application.candidate_id
 LEFT JOIN sm_candidate_medical_status ON sm_candidate.candidate_id=sm_candidate_medical_status.candidate_id WHERE 
 sm_candidate.candidate_status='1' AND `medical_status`='fit'");
...
<section id="content">
    <div class="page page-shop-products">
        <div class="pageheader">
            <h2>Medical Cleared List <span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Medical Cleared</strong> List</h1>
...
<script>
            ...
            "columns": [
                ...
                {"data": "candidate_code"},
                {
                    ...
                    "render": function (data, type, full, meta) {
                        ...
                        return '<a href="candidate_medical_profile.php?can_id=' + full.candidate_id + '" class=""><i class=""></i> ' + data + '</a>';
                ...
                {"data": "candidate_phone"},
                {
                    ...
                    "data": "company_id",
                    "render": function (data, type, full, meta) {
                        return '<a href="candidate_medical_gallery.php?can_id=' + full.candidate_id + '" class="btn btn-xs btn-green"> View</a>&nbsp<a onclick="delete_id(' + full.candidate_id + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"></i>Cancel</a>';
                    }}
            ],
            "aoColumnDefs": [
    ...
    $('#del_btn').click(function () {
        ...
        $.ajax({
            url: "final_candidate_medical_delete.php",
            type: "POST",
            data: {sele_can: sele_can},
            success: function (data) {
               // alert(data);
                window.location = "final_candidate_medical_cleared.php";
            }
        });
    });

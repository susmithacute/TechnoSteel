...
//$today = date('Y-m-d');
                                ...
                                $selToday = $db->selectQuery("SELECT * FROM `sm_notification` WHERE `notification_start_date`='$today' AND `document_title`='$doc_single' ORDER BY `notification_id` DESC");
                                ...
                                $selYesterday = $db->selectQuery("SELECT * FROM `sm_notification` WHERE `notification_start_date`='$yesterday'AND `document_title`='$doc_single' ORDER BY `notification_id` DESC");
                                ...
                                $selDates = $db->selectQuery("SELECT DISTINCT  `notification_start_date` FROM `sm_notification` WHERE `document_title`='$doc_single' AND `notification_start_date`< DATE_SUB(NOW(), INTERVAL 1 DAY)");
                                ...
                                if (count($selDates)) {
                                    ...
                                    for ($gn = 0; $gn < count($selDates); $gn++) {
                                        ...
                                        $selData = $db->selectQuery("SELECT * FROM `sm_notification` WHERE `document_title`='$doc_single' AND `notification_start_date`='$sdate' ORDER BY `notification_id` DESC")
                                        ...
                                        for ($fu = 0; $fu < count($selData); $fu++) {
                                            ...
                                            if (strpos($notfD, "Commercial Registration") !== false) {
                                            ...
                                            if (strpos($notfD, "Municipal License") !== false) {

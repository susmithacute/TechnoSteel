...
$empArray = array();
$resFet = $db->selectQuery("SELECT * FROM `sm_work_site` WHERE `status` = 'active'");
if (count($resFet)) {
...
$fp = fopen('assets/extras/worksite.json', 'w');
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Work Location List<span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Work Location List</strong></h1>
                            <ul class="controls">
							<li>
 <a href="worksite_add.php" role="button" tabindex="0" class="tile-add" title="Add worksite">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:90px;">Work Site</th>
                                            <th style="width:90px;">Site Location</th>
...
<script>
    $(window).load(function () {
      ...
      var t=  $('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": 'assets/extras/worksite.json',
            "order": [[1, "asc"]],
            "columns": [
                {
                    "data": null,
                ...
                {"data": "site_location"},
                {
                    ...
                    "render": function (data) {
                        return '<a href="worksite_edit.php?uid=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
            ],
            "aoColumnDefs": [

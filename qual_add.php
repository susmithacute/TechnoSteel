...
<section id="content">
    ...
    <div class="page page-forms-wizard">
        ...
        <div class="pageheader">
            <h2>Add Qualification<span></span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Add Qualification</a>
                    </li>
                </ul>
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
               <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Add New Qualification </a></li>
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="qual[0][qualification_name]" id="qual_name" class="form-control" required>
                                    <span id="exist_status" class="validate_span"></span>

                                </div>
                          </div>
						   <div class="experience_div"></div>
						    <input type="hidden" value="1" id="qual_increment">
                            <div class="row">
                           
						  <div class="col-md-3">
                                    <button class="btn btn-success" type="button" id="country_add_btn" >Add qualification
...
$('#submit_btn').click(function(){
	...
	var error_check=1;
    var qual_name = jQuery('#qual_name').val();
...
<script>
	 $('#country_add_btn').click(function () {
        ...
        var country_add = "qual_add";
        qual_increment = $('#qual_increment').val();
        added_exp = +qual_increment + 1;
        $('.experience_div').append(
                '<div class="row">'
                + '<div class="form-group col-md-6">'
                + ' <label for="username">Qualification Name: </label>'
                + '<input type="text"  name="qual[' + qual_increment + '][qualification_name]"  class="form-control"  id="qual_name"  required="" > '
				+ ' <span id="exist_status_' + qual_increment + '" class="validate_span"></span>'
                + '</div>'
				 + '</div>'
				  );
                $('#qual_increment').val(added_exp);
    });
</script>
</body>
</html>

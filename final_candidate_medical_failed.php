...
$head = "";
$head1 = "";
//$sub1 = "final_candidate_medical_failed";
$tab1 = "";
...
WHERE sm_candidate.candidate_status='1' AND `medical_status`='unfit'");
...
<section id="content">
    <div class="page page-shop-products">
        <div class="pageheader">
            <h2>Medical Failed List <span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Medical Failed</strong> List</h1>
	   ...
	   $('#del_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
               // alert(data);
                window.location = "final_candidate_medical_failed.php";
            }
        });
    });

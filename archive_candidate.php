...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Candidate Archive <span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <h1 class="custom-font"><strong>Candidate</strong> Archive</h1>
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                location.href = "archive_candidate.php";

...
if (isset($_POST['submit'])) { echo "haisucc";
	...
	if($travel_eligibility == "One way"){
		...
		{
			echo "Updated";
			echo "<script>window.location = 'accounts_employee_other_travel_booked_profile.php?employee_id=".$employee_id."'</script>";
		} 
		else {
	echo "<script>location.href='accounts_employee_other_travel_booked_edit.php?employee_id=".$employee_id."'</script>";
    }

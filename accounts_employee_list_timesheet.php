<?php
$page = "accounts";
$sub = "accounts_employee_timesheet";
$sub1 = "accounts_employee_list_timesheet";
...
$fp = fopen('assets/extras/account_employee.json', 'w');
...
<script>
    $(window).load(function () {
      ...
      var t=  $('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": 'assets/extras/account_employee.json',
            "order": [[2, "desc"]],
            "columns": [
                {
                    "data": null,
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return '<a href="accounts_employee_read.php?uid=' + full.employee_id + '" class=""><i class=""></i> ' + data + '</a>';
                    }},
                ...
                
                {
                    ...
                    "render": function (data, type, full, meta) {
						...
						return '<a href="accounts_time_sheet.php?uid=' + data + '" class="btn btn-xs btn-blue mr-5"><i class="fa fa-pencil"></i> Time Sheet</a>';
                    }}
            ],
            "aoColumnDefs": [
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "accounts_employee_list.php";
            }
        });
    });

    ...
    <div class="page page-gallery">
        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs tabs-dark" role="tablist">
                <li role="presentation"><a href="employee_read.php?uid=<?php echo $id; ?>" >Profile</a></li>
                
                <li role="presentation"><a href="emp_medical_doc_gallery.php?uid=<?php echo $id; ?>" style="color:#16a085;">Documents</a></li>
            </ul>

...
$first_code_gen = $can_code . "_C" . $cand_id;
						...
						<?php } ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control mb-10" name="agent_code" id="agent_code">
                                        <option value=""> Select</option>
                                        <option value="other"> Others</option>
                                        <?php
                                        $select_agents = $db->selectQuery("SELECT * FROM `sm_recruitment_agents` WHERE `agent_status`='1'");
                                        if (count($select_agents)) {
                                            for ($ai = 0; $ai < count($select_agents); $ai++) {
                                                ?>
                                                <option value="<?php echo $select_agents[$ai]['agent_area_id'] ?>"><?php echo $select_agents[$ai]['agent_company']; ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="companyname">Candidate ID: </label>
                                    <input type="text" name="candidate_code" class="form-control" id="candidate_code" value="<?php echo $first_code_gen; ?>" readonly="">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 ">
                                    ...
                                    <div class='input-group datepicker' data-format="L">
                                        <input type='text' name="candidate_dob" class="form-control" onkeydown="return false" />
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="dnumber">Address: </label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="candidate_zipcode" id="zip" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="username">Email: </label>
                                    <input type="email" name="candidate_email" class="form-control" onblur="validateEmail(this);"/>
									<span id="emailval" style="color:#FF0000"></span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="companyname">Phone: </label>
                                    <input type="text" name="candidate_phone" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <form name="step4" role="form" id="step4">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type='text' name="experience[0][experience_from]" class="form-control date_pick" id="qual_date_from" onkeydown="return false"/>
                                </div>
                                <div class="form-group col-md-4 ">
                                    <label for="scstart">To: </label>
                                    <input type='text' name="experience[0][experience_to]" class="form-control date_pick" id="qual_date_to" onkeydown="return false"/>
                        ...
                        <form name="step5" id="step5" role="form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group ' data-format="L">
                                        <input type='text' name="documents[0][documents_start_date]"
                                               class="form-control  date_pick" id="pro_date_from" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                ...
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[0][documents_end_date]" class="form-control date_pick"  id="pro_date_to" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[1][documents_start_date]"
                                               class="form-control date_pick"  id="dr_date_from" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[1][documents_end_date]" class="form-control date_pick"  id="dr_date_to" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="sam">
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i
											...
											<input type="hidden" name="emp_docs[0][documents_title]" value="Candidate_Picture" />
									...
									<div class="sam">
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i
											...
											<input type="hidden" name="emp_docs[1][documents_title]" value="Resume" />
									...
									<div class="sam">
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i
											...
											<input type="hidden" name="emp_docs[2][documents_title]" value="Experience_Certificates" />
									...
									<div class="sam">
                                        <label class="col-sm-6 control-label">ID Card</label>
                                        <span class="btn btn-success fileinput-button"> <i
                                                class="glyphicon glyphicon-plus"></i>
                                            <span class="">Add files...</span>
                                            <input type="file" name="files" class="" id="profile_pic"
                                                   onchange="upload_files(this)" >
                                            <input type="hidden" value="ID_Card" name="ID_Card" class="dfile">
											<input type="hidden" name="emp_docs[3][documents_title]" value="ID_Card" />
									...
									<div class="sam">
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i
                                            ...
                                            <input type="file" name="files" class="" id="profile_pic"
                                                   onchange="upload_files(this)" >
                                            <input type="hidden" value="Driving_License" name="Driving_License" class="dfile">
											<input type="hidden" name="emp_docs[4][documents_title]" value="Driving_License" />
                                    ...
                                    <div class="sam">
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i
											...
											<input type="hidden" name="emp_docs[5][documents_title]" value="Passport_Documents" />
...
$('#dr_date_from').datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true,onSelect: function(date) {
$("#dr_date_to").datepicker('option', 'minDate', date);} });
$('#dr_date_to').datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true});

$('#qual_date_from').datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true,onSelect: function(date) {
$("#qual_date_to").datepicker('option', 'minDate', date);} });
$('#qual_date_to').datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true});
</script>
...
?>
    ...
    $('#agent_code').change(function () {
		...
		if(agent_code === ""){
			...
			var cand_code = <?php echo $first_code_gen ?>;
			$('#candidate_code').val(cand_code);
    ...
    $('#finish_btn').click(function () {
        ...
        $.ajax({
            ...
            data: fdata,
            success: function (data) {
                $('#SucM').html('Candidate added successfully');
				if(data == 'from_interview'){
				setTimeout('', 1000);
				window.location = "interview_form.php";
				} else {
					//alert(data);
				setTimeout('', 1000);
...
<script>
	...
	function validateEmail(emailField){
        ...
        if (reg.test(emailField.value) == false) 
        {
			...
			$('#emailval').html('Invalid Email Address').fadeOut(5000);
			//$('#emailval').html('Invalid Email Address');
            return false;
        } else {
			return true;
		}

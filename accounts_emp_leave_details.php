                        ...
                        <div class="tile-body p-0">
                            <div role="tabpanel">
                                <ul class="nav nav-tabs tabs-dark" role="tablist">
									...
									<li role="presentation"><a href="employee_gallery.php?uid=<?php echo $_GET['uid'] ?>">Leave Details</a></li>
                                </ul>
                                        ...
                                        <div class="wrap-reset">
                                            ...
                                            <form class="profile-settings">
                                                ...
                                                <div class="row">
												 ...
												 <button type="button" class="btn btn-primary custom  mb-10" type="button" ><a style="color:#fff;text-align:center;" href="accounts_emp_casual_leave.php?uid=<?php echo $_GET['uid'] ?>">Casual  Leave </a></button>
												 </div>
												 <div class="row"> <div class="col-sm-3"> </div></div>
												  <div class="row">
												  <div class="col-sm-3"> </div>
												 <button type="button" class="btn btn-primary custom   mb-10" type="button"><a style="color:#fff ;text-align:center;" href="accounts_emp_medical_leave.php?uid=<?php echo $_GET['uid'] ?>">Medical Leave</a></button>
												 </div>
													 <div class="row"> <div class="col-sm-3"> </div></div>
												  <div class="row">
												  <div class="col-sm-3"> </div>
												 <button type="button" class="btn btn-primary custom  mb-10" type="button"><a style="color:#fff ;text-align:center;" href="accounts_emp_annual_leave.php?uid=<?php echo $_GET['uid'] ?>">Annual Leave</a></button>
												  </div>

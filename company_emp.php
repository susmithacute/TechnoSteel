...
//$resFet = "SELECT CONCAT (`employee_firstname`,' ',`employee_lastname`) as `full_name`,`employee_designation`,`employee_company`,`employee_id`,`employee_qatar_start`,`employee_email` FROM `sm_employee` WHERE `sponsor_id`='" . $_SESSION['id'] . "'  AND `	employee_status`='1'";
...
AND sm_employee.employee_status =1 AND employee_company='$cid'");
$employee_company = $resFet[0]['company_name'];
$empArray = array();
if (count($resFet)) {
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Employee List</strong><h1> -<?php echo$employee_company;?></h1>
                            <ul class="controls">
                                <li class="dropdown">

                                            ...
                                            <form class="profile-settings">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-4">
                                                        ...
                                                        <input type="text" class="form-control" name="f_name" id="f_name" value="<?php echo $employee_firstname; ?>">
                                                    </div>


                                                    <div class="form-group col-sm-4">
                                                        <label for="last-name">Middle Name</label>
                                                        <input type="text" class="form-control" name="m_name" id="m_name" value="<?php echo $employee_middlename; ?>">
                                                    </div>


                                                    <div class="form-group col-sm-4">
                                                        <label for="last-name">Last Name</label>
                                                        <input type="text" class="form-control" name="l_name" id="l_name" value="<?php echo $employee_lastname; ?>">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="p_address" id="p_address" value="<?php echo $employee_peraddress1; ?>">
                                                    </div>

                                                    <div class="form-group col-sm-6">
                                                        <label for="address2">Temporary Address</label>
                                                        <input type="text" class="form-control" name="t_address" id="t_address" value="<?php echo $employee_resiaddress1; ?>">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-4">
                                                        ...
                                                        <input type="text" class="form-control" name="city"  id="city" value="<?php echo $employee_percity; ?>">
                                                    </div>

                                                    <div class="form-group col-sm-4">
                                                        <label for="state">State/Provice</label>
                                                        <input type="text" class="form-control" name="state" id="state" value="<?php echo $employee_perstate; ?>">
                                                    </div>

                                                    <div class="form-group col-sm-4">
                                                        <label for="zip">Zip Code</label>
                                                        <input type="text" name="zip" class="form-control" id="zip" value="<?php echo $employee_perzip; ?>">
                                                    </div>
...
<!--                                                            <input type="text" class="form-control" name="gender" id="gender" value="<?php echo $val['employee_gender']; ?>">-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="company" id="company" value="<?php echo $employee_company; ?>">
                                                    </div>

                                                    <div class="form-group col-sm-6">
                                                        <label for="city">Designation</label>
                                                        <input type="text" class="form-control"  name="desig"  value="<?php echo $employee_designation; ?>">
                                                    </div>
                                                        ...
                                                        <select name="country"class="form-control" readonly>
                                                            ...
                                                            if (count($sql)) {
                                                                for ($cun = 0; $cun < count($sql); $cun++) {
                                                                    ?>
                                                                    <option value="<?php echo $sql[$cun]['id']; ?>" <?php if ($employee_nationality == $sql[$cun]['id']) { ?> selected=""<?php } ?>><?php echo $sql[$cun]['nicename']; ?></option>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>

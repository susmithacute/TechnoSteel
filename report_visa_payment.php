...
$cmpArray = array();
$resFet = $db->selectQuery("SELECT `visa_id`,`visa_category`, `visa_type`, `visa_client_name`, `visa_advance_amount`, `visa_sponsor`, `visa_bank_fee`, `visa_company_fee`, `visa_sponsor_fee`, `visa_total_amount`, `visa_amount_balance` FROM `sm_visa` WHERE `visa_active`=1");
if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
        ...
        $values['visa_advance_amount'] = $resFet[$rC]['visa_advance_amount'];
        ...
        $values['visa_total_amount'] = $resFet[$rC]['visa_total_amount'];

                        ...
                        <form name="step1" role="form" id="step1">
                            ...
                            <div class="row">
								...
								<div class="form-group col-md-4">
									...
									<option  value="">Select</option>
                                        <?php
                                        $select = $db->selectQuery("select * from sm_designation ");
                                        if (count($select)) {
                                            for ($rt = 0; $rt < count($select); $rt++) {
                                                ?>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div>
                                        ...
                                        <span class="btn btn-success fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Add files...</span>
                                            <input type="file" name="files[]" class="step5"  multiple>
...
<!--                                    <button type="submit" name="sub" id="upload"  class="btn btn-primary start"> <i class="glyphicon glyphicon-upload"></i> <span>Start upload</span> </button>
                    ...
                    <div class="row">
                        ...
                        <h3 class="text-success mt-0 mb-20" id="SucM"></h3>
...
<script>
    $('.step5').change(function () {
        var section = $(this).siblings('.dfile').val();
        var cp_id = $('#company').val();
        var fname = $('#qatar_id').val();
        var numf = 0;
        var formData = new FormData();
        jQuery.each(jQuery('.step5')[0].files, function (i, file) {

                            ...
                            <div role="tabpanel">
							  ...
							  <div class="row">
                                   <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="company_account_no" id="company_account_no" class="form-control" readonly value="<?php echo @$company_account_no; ?>"
                                           />
                                <span style="padding-left:0px" id = "exist_status" style="color:red" class="validate_span"></span>
                                    ...
                                    <input type="text" name="company_iban_no" id="company_iban_no" class="form-control" readonly value="<?php echo @$company_iban_no; ?>"/>
                                                    ...
                                                    for ($cd = 0; $cd < count($contacts); $cd++) {
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <label class="checkbox checkbox-custom-alt">
                                                                    <input type="checkbox" name="contact_not[0][ml]" id="ml" readonly disabled="disabled" value="Municipal Licence" <?php echo $comnot3; ?>><i></i>  Municipal Licence Expiry
                                                                </label>
                                                                <label class="checkbox checkbox-custom-alt">

...
if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
        ...
        $date_display=$date[2]."-".$date[1]."-".$date[0];
        ...
        $values['payroll_received_date']=$date_display;
            ...
            "columns": [
                ...
                {"data": "payroll_received_date"},
                {
                    ...
                    "render": function (data) {
                        return '<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-red" data-toggle="modal" data-target="#splash1" data-options="splash-ef-3"><i class="fa fa-check"></i>Edit Status</a>';
                    }}
            ],
            "aoColumnDefs": [

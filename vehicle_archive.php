...
$resFet = $db->selectQuery("SELECT `vehicle_auto_id`,`vehicle_id`,`vehicle_company`,`vehicle_assigned_company`,`vehicle_assigned_employee` FROM `sm_vehicle` WHERE `sponsor_id`='".$_SESSION['id']."' AND `vehicle_status`='0'");
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Vehicle Archive List<span></span></h2>
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "vehicle_archive.php";

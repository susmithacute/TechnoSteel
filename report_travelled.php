...
$sub = "req_travelled_report";
//$sub1="Travelled_Candidate_List";
...
$resFet = $db->selectQuery("SELECT CONCAT( sm_candidate.candidate_firstname,  ' ', sm_candidate.candidate_middlename,  ' ',
 sm_candidate.candidate_lastname ) AS candidate_name, sm_candidate.candidate_code,sm_candidate.candidate_id,sm_candidate.candidate_nationality,sm_travelling_details.date_of_travel,sm_travelling_details.Arrival_time,
 sm_travelling_details.candidate_id,sm_travelling_details.entry_date,sm_candidate_visa_process.visa_type,
...
$fp = fopen('assets/extras/travelled_cand.json', 'w');
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Travelled Candidate List</strong> </h1>
                            <ul class="controls">
...
<script>
                                                $(window).load(function () {
                                                  ...
                                                  $('#products-list').DataTable({
                                                        ...
                                                        "pagingType": "input",
                                                        "ajax": 'assets/extras/travelled_cand.json',
                                                        "order": [[0, "asc"]],
                                                        "columns": [

        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
               <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Add New Skill</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="tab1">
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                                    ...
                                    <select class="form-control mb-10" name="skill[0][skill_job]" id="skill_job" required="">
								 ...
								 <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control mb-10" name="skill[0][skill_category]" id="skill_category"
                                            required="">
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="skill[0][skill_name]" id="skill_name" class="form-control" required>
                                    <span id="exist_status" class="validate_span"></span>

                                </div>
                          </div>
						  <div class="experience_div"></div>
                            <input type="hidden" value="1" id="skill_increment">
						   <div class="row">
                                <div class="col-md-3">
...
<script>
	 $('#category_add_btn').click(function () {
        ...
        var skill_add = "skill_add";
        skill_increment = $('#skill_increment').val();
        added_exp = +skill_increment + 1;
        $('.experience_div').append(
                '<div class="row">'
                + '<div class="form-group col-md-4">'
				+ ' <label for="phone">Job Position: </label>'
                + '<select class="form-control mb-10" name="skill[' + skill_increment + '][skill_job]" id="skill_job" required="" >'
...
?>
        + '</select>'
                ...
                + '<select class="form-control mb-10"  name="skill[' + skill_increment + '][skill_category]"  id="skill_category"  required=""> '
				+ '<option value="">Select</option>'
				 + '</select>'
				 + ' <span id="exist_status_' + skill_increment + '" class="validate_span"></span>'
			    + '</div>'
				
				
				 + '<div class="form-group col-md-4">'
                + '<label for="username">Skill Name: </label>'
                + '<input type="text"  name="skill[' + skill_increment + '][skill_name]"  class="form-control"  id="skill_name"  required=""> '
				 + ' <span id="exist_status_' + skill_increment + '" class="validate_span"></span>'
			    + '</div>'
				 + '</div>'
				
				  );
                $('#skill_increment').val(added_exp);
    });

...
?>
                ...
                $res = $db->selectQuery("select * from sm_insurance_company where insurance_company_id	='" . $_GET['insurance_company_id'] . "' ");
...
if (isset($_POST['submit'])) {
	...
	$values1['insurance_company_name'] = $insurance_company_name;
	$query1 = $db->secure_update('sm_insurance_company', $values1, "  WHERE insurance_company_id = '" . $_GET['insurance_company_id'] . "'");
	if (count($query1)) {
...
<section id="content">
    ...
    <div class="page page-forms-wizard">
        ...
        <div class="pageheader">
            ...
            <h2>Edit Insurance Company<span></span></h2>
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Edit Insurance Company</a>
                    </li>
                </ul>
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Edit Insurance Company </a></li>
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="username">Insurance Company Name: </label>
                                    <input type="text" name="insurance_company_name" id="insurance_company_name" value="<?php echo $insurance_company_name;?> "class="form-control" required>
                                </div>
								
								<input type="hidden" id="edit_id" name="edit_id" value="<?php echo $insurance_company_id; ?>">
...
$('#insurance_company_name').on('keyup', function (e) {
        ...
        $.ajax({
            url: 'insurance_company_check_edit.php',
            type: 'POST',
            dataType: 'json',
            data: {insurance_company_name: insurance_company_name,edit_id:edit_id},

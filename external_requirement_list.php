                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <ul class="controls">
														...
														<li>
 <a href="external_requirement_add.php" role="button" tabindex="0" class="tile-add" title="External Requirement">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
									...
									<div id="err" style="color:#F00;"></div>
									<div id="valid-wage-error" style="color:#F00;"></div>
		  ...
		  <button class="btn btn-default btn-border" data-dismiss="modal" id="can_btn">Cancel</button>
           <!-- <button  class="btn btn-default btn-border" id="hiring_req">Hiring</button>-->
			...
			<button style="display:none" class="btn btn-default btn-border" id="hiring_req">Hiring</button>
...
<div class="modal splash fade"  tabindex="-1" role="dialog" aria-labelledby "myModalLabel"> 
...
================================================ -->
<script>
function validate_wage(wage)
                {
                    var reg = /^[0-9]*$/;
                    return reg.test(wage);
                }
        ...
        var t =$('#products-list').DataTable({
            ...
            "columns": [
				...
				//Process
				{
					...
					"data": "hiring_requirment_id",
					"render": function (data,type,full,meta) {
                        return '<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-red" data-toggle="modal" data-target="#splashdel" data-options="splash-ef-3">Delete</a><a href="external_requirement_edit.php?edit_id=' + full.id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i>Edit</a>';
                }},
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "external_requirement_list.php";
            }
        });
    });
	...
	$('#can_btn').click(function () {
	 ...
	 $('#submitted').click(function () {
       var hire_id			= $('#hid_del').val();
		...
		if(employees =='' || wage =='')
		{
			$('#err').html("This Field is Required*").fadeOut(3000);;
		} else {
			
			if (wage != '' && !validate_wage(wage))
                    {
                        $('#valid-wage-error').css('display', 'block').append('</br>Please Enter a Valid Wage');
                        log_error = 1;
                    }
			else{		
          ...
          $.ajax({
            ...
            success: function (data) {
				//alert (data);
                    ...
                    $("#Succ").html("Passed");
					location.href = 'hiring_requirment_add.php?uid='+ hir_id;
                }
				else
				{
					 $(Succ).html("");

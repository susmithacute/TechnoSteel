...
$resFet = $db->selectQuery("SELECT  `vehicle_auto_id`,`vehicle_company`,`vehicle_id`,`vehicle_manufacturer`,`vehicle_model`,`vehicle_assigned_company`,`vehicle_assigned_employee` FROM `sm_vehicle` where `vehicle_assigned_company`='$vid' AND `vehicle_status`='1' ORDER BY vehicle_auto_id DESC");
$partArray = array();
if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
		...
		$ass_mod=$db->selectQuery("SELECT `model_name` FROM `sm_vehicle_model` WHERE `model_id`='$vehicle_model'");
		$ass_man=$db->selectQuery("SELECT `manufacturer_name` FROM `sm_vehicle_manufacturer` WHERE `manufacturer_id`='$vehicle_manufacturer'");
        ...
        $values['vehicle_assigned_company']=$company_name=$ass_com[0]['company_name'];

        $values['employee_name'] = $ass_emp[0]['full_name'];
		$values['vehicle_model'] = $ass_mod[0]['model_name'];
		$values['vehicle_manufacturer'] = $ass_man[0]['manufacturer_name'];
       
        //$values['company_status'] = $resFet[$rC]['company_status'];
        $partArray["data"][] = $values;
    }
}
$fp = fopen('assets/extras/vehicle_company.json', 'w');
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Vehicle List -<?php echo $company_name; ?><span></span></h2>
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:190px;">Assigned Company</th>
...
<script>
    $(window).load(function () {
        ...
        $('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": 'assets/extras/vehicle_company.json',
            "order": [[1, "asc"]],
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "vehicle_company.php?vid=<?php echo $vid;?>";

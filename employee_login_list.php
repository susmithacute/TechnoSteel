...
sm_employee.employee_id,sm_employee.employee_employment_id,sm_employee.employee_company, sm_employee.employee_designation,sm_employee_login.id,sm_employee_login.employee_username,sm_employee_login.employee_password,sm_company.company_name
FROM sm_employee
INNER JOIN sm_employee_login ON sm_employee.employee_id = sm_employee_login.employee_id INNER JOIN sm_company ON sm_employee.employee_company =sm_company.company_id ");
if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
       ...
       $values['employee_designation'] = $resFet[$rC]['employee_designation'];
        $values['employee_username'] = $resFet[$rC]['employee_username'];
        $values['employee_password'] = $resFet[$rC]['employee_password'];
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Employee Login List<span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Employee Login List</strong></h1>
                            <ul class="controls">
							    <li>
                                     <a href="employee_login.php" role="button" tabindex="0" class="tile-add" title="add">
            ...
            "columns": [
			
				{
				...
				
				 {
                    ...
                    "data": "employee_id",
                    "render": function (data, type, full, meta) {
                        return '<a href="employee_login_read.php?emp_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a></a><a onclick="delete_id(' + full.id + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
            ],
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "delete_emp_login.php",
            type: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
              window.location = "employee_login_list.php";
            }
        });
    });
</script>

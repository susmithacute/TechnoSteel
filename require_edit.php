                        ...
                        <div class="tile-body p-0">
                            <div role="tabpanel">
                                <ul class="nav nav-tabs tabs-dark" role="tablist">
                                    <li role="presentation"><a href="require_view.php?uid=<?php echo $uid; ?>" >Inhouse requirement</a></li>
                                    <li role="presentation"><a href="require_edit.php?uid=<?php echo $uid; ?>" style="color:#16a085;">Edit </a></li>
                                    
                                </ul>
                                 <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="settingsTab">
                                        <div class="tile-body">
                                   <form class="form-horizontal" name="" method="post" action="require_edit_action.php"

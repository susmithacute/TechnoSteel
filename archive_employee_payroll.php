...
WHERE sm_payroll.payroll_status = 'Cancelled'
            ...
            "columns": [
                ...
                {"data": "company_name"},
                {
                    ...
                    "render": function (data) {
                        return '<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#splash1" data-options="splash-ef-3"><i class="fa fa-plus"></i> Restore</a>';
                    }}
            ],
            "aoColumnDefs": [
...
<script type="text/javascript">
    ...
    $('#update_btn').click(function () {
        ...
        $.ajax({
            url: "payroll_actions_employee.php",
            type: "POST",
            data: {payroll_archive: pass_val},
            success: function (data) {
                window.location = "archive_employee_payroll.php";
            }
        });
    });
</script>

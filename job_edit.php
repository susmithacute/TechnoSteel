...
?>
             <?php
                ...
                $res = $db->selectQuery("select * from sm_job_positions where job_id='" . $_GET['job_id'] . "' ");
...
if (isset($_POST['submit'])) {
    ...
    $values1['job_name'] = $job_name;
	$query1 = $db->secure_update('sm_job_positions', $values1, "  WHERE job_id = '" . $_GET['job_id'] . "'");
	if (count($query1)) {
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Edit job </a></li>
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="job_name" value="<?php echo $job_name;?>" id="job_name" class="form-control" required>
                                    <span id="com_status" class="validate_span"></span>

                                </div>
                          </div>
						  <input type="hidden" name="edit_id" id="edit_id" value="<?php echo $job_id; ?>" />
						   <div class="col-md-6">

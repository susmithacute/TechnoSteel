...
$sql = $db->selectQuery("SELECT `medical_status` from sm_candidate_medical_status WHERE `candidate_id`='$candidate_id'");
 if(!empty($sql))
 {
	$medical_status =$sql[0]['medical_status'];
	 $values['medical_status'] =ucfirst("$medical_status");
...
$fp = fopen('assets/extras/report_process_candidate.json', 'w');
...
<script>
                                                $(window).load(function () {
                                                  ...
                                                  $('#products-list').DataTable({
                                                        ...
                                                        "pagingType": "input",
                                                        "ajax": 'assets/extras/report_process_candidate.json',
                                                        "order": [[0, "asc"]],
                                                        "columns": [
                                                            {"data": "sl_no"},

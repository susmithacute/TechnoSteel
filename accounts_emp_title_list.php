<?php
$page = "accounts";
$sub = "accounts_assign_list";
include('file_parts/header.php');

$empArray = array();
$resFet = $db->selectQuery("SELECT sm_employee_work_assign.id,sm_employee_work_assign.type,sm_employee_work_assign.issued_date_from,
sm_employee_work_assign.issued_date_to,sm_employee_work_assign.title,sm_designation.designation_name
 FROM sm_employee_work_assign INNER JOIN sm_designation ON sm_employee_work_assign.job_position_id=sm_designation.designation_id AND
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a>Worksite List-All Companies</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Worksite  List  <?php //echo $resFet[$rC]['id']; ?></strong>-All Companies</h1>
                            <ul class="controls">
                                <li class="dropdown">
            ...
            "columns": [
                ...
                //},
				{
                    ...
                    "render": function (data, type, full, meta) {
                        return '<a href="accounts_emp_work_assign_list.php?work_assign_id=' + full.id + '" class=""><i class=""></i> ' + data + '</a>';
                    }},
				//{"data": "employee_employment_id"},
                //{"data": "fullname"},
                {"data": "type"},
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = "accounts_emp_title_list.php";
            }
        });
    });
</script>

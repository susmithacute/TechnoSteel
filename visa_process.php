                        ...
                        <div class="tile-body p-0">
                            ...
                            <div role="tabpanel">
                                ...
                                <ul class="nav nav-tabs tabs-dark" role="tablist">
                                    <li role="presentation"><a style="color:#16a085;" href="#">Visa Processing Form</a></li>
                                </ul>
                                <!-- Tab panes -->
								...
								<div class=" col-md-6">
									  ...
									  <div class='input-group datepicker' data-format="L">
                                        ...
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
												...
												<div class="row">
													 ...
													 <div class=" col-md-6">
                                                         <label for="phone">Entry Date: </label>
									  <div class='input-group datepicker' data-format="L">
                                        <input type='text' name="candidate_dob" class="form-control"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                   ...
                                   <select class="form-control mb-10" name="visa_status" id="visa_status">
										...
										<option  value="Not Applied">Processed</option>
										<option  value="Not Applied">Issued</option>

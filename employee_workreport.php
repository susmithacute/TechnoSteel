...
$resFet = $db->selectQuery("SELECT CONCAT( sm_employee.employee_firstname,  ' ', sm_employee.employee_middlename,  ' ', sm_employee.employee_lastname ) AS full_name, sm_employee.employee_id,sm_employee.employee_employment_id,sm_employee.employee_designation,sm_employee_attendance.attendance_date,sm_employee_attendance.attendance_punch_in_time,sm_employee_attendance.attendance_punch_out_time,sm_employee_attendance.attendance_punch_in_location,sm_employee_attendance.attendance_punch_out_location FROM sm_employee INNER JOIN sm_employee_attendance ON sm_employee.employee_id=sm_employee_attendance.employee_id");
...
<script>
    ...
    $(window).load(function () {
        ...
        var t =$('#products-list').DataTable({
            ...
            "ajax": 'assets/extras/workreport.json',
               ...
               {"data": "employee_designation"},
				{
                    ...
                    "data": "employee_id",
                    "render": function (data, type, full, meta) {
                        return '<a href="employee_workreportStatus.php?report_id=' + full.report_id + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> View Report</a>';
                    }}
              ],
            "aoColumnDefs": [

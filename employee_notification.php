        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">employee Notifications</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile tile-simple no-bg">
                        ...
                        <div class="tile-body streamline timeline p-0">
                            <ul>
                                <?php
                                $notif = $db->selectQuery("SELECT * FROM `sm_company` WHERE `sponsor_id`='" . $_SESSION['id'] . "' AND `company_status`='1'");
                                if (count($notif) > 0) {
                                    ?>
                                    <li class="heading">
                                    ...
                                    <li class="timeline-post">
                                        ...
                                        <div class="post-container">
                                            <div class="panel panel-default b-0">
                                                ...
                                                <p class="text-blue">Sed voluptatem sequi nesciunt.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <?php

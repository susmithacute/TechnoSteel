...
$fp = fopen('../assets/extras/agents_candidate.json', 'w');
...
<script>
    $(window).load(function () {
        ...
        var t = $('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": '../assets/extras/agents_candidate.json',
            "order": [[1, "desc"]],
            "columns": [
                {"data": null},
                {"data": "candidate_code"},
                {
                    ...
                    "render": function (data, type, full, meta) {
                        ...
                        return '<a href="candidate_profile.php?can_id=' + full.candidate_id + '" class="" target="_blank"><i class=""></i> ' + data + '</a>';

                ...
                <div class="tab-content">
                    <div class="tab-pane" id="tab1">
                        <form name="step1" role="form" id="step1">
                            ...
                            <div class="row">
                                <input type="hidden" name="agent_code" value="<?php echo $agent_area_id ?>">
                                
                                <div class="form-group col-md-6">
                                    <label for="companyname">Candidate ID: </label>
                                    <input type="text" name="candidate_code" class="form-control" id="candidate_code" readonly="">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[0][documents_start_date]"
                                               class="form-control" id="pro_date_from" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[0][documents_end_date]" class="form-control" id="pro_date_to" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[1][documents_start_date]"
                                               class="form-control" id="dr_date_from" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class='input-group' data-format="L">
                                        <input type='text' name="documents[1][documents_end_date]" class="form-control" id="dr_date_to" onkeydown="return false"/>
                                        <span class="input-group-addon"> <span class="fa fa-calendar"></span> </span>
                                    </div>
                                </div>
                            </div>
...
<script>
   /* $(window).load(function () {
    ...
    $(document).ready(function () {
        var agent_code = "<?php echo $agent_area_id; ?>";
        $.ajax({
    ...
    function upload_files(element) {
        ...
        $.each($(element)[0].files, function (i, file) {
            ...
            if (fileSize > sizeLimit) {
                file_ok = 0;
                //$(element).parent('span').siblings('.file_status').hide();

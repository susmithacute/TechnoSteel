                ...
                <div class="container w-420 p-15 bg-white mt-40">
                    ...
                    <div class="media p-15">
						...
						<?php
                            ...
                            ?>
                            <img class="media-object img-circle" src="../assets/images/profile-default.png" alt="">
                        </div>
                        <div class="media-body">
							<?php $username = $db->selectQuery("SELECT `agent_email` FROM `sm_recruitment_agents` WHERE agent_id = '".$_SESSION['agent_id']."'");
							
							?>
                            <!--<form name="form" class="form-validation">-->
							<form name="form" class="form-validation" novalidate="" action="" method="post">
							<?php if(!empty($name)){ ?>
                                <h4 class="media-heading mb-0"><strong><?php echo $name; ?></strong></h4>
							<?php } ?>
                                ...
                                <div class="form-group text-left">
								   ...
								   <input type="hidden" class="form-control underline-input" name="username" value="<?php echo $username[0]['agent_email']; ?>" >

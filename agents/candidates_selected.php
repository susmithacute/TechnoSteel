    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                location.href = "candidates_selected.php";
            }
        });
    });
</script>

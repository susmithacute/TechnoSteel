...
$sub = "recruit_job";
$sub1 = "recruit_job_list";
include("./file_parts/header.php");
$job_list = $db->selectQuery("SELECT  `job_id`, `job_name` FROM `sm_job_positions` where `job_status`='1' ORDER BY job_id DESC ");
if (count($job_list )) {
    for ($cou = 0; $cou < count($job_list ); $cou++) 
	{
		$sl=$cou+1;
	    $values['sl_id']=$sl;
        $values['job_id'] = $job_list[$cou]['job_id'];
        $values['job_name'] = $job_list[$cou]['job_name'];
		//$values['company_status'] = $resFet[$rC]['company_status'];
        $coufArray["data"][] = $values;
    }
}
$fp = fopen('assets/extras/job.json', 'w');
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Job List</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Job List</h1>
                            <ul class="controls">
...
<li>
 <a href="job_add.php" role="button" tabindex="0" class="tile-add" title=" Add Job">
            ...
            "columns": [
               ...
               
                {
                    ...
                    "render": function (data) {
                        return '<a href="job_edit.php?job_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
            ],
            "aoColumnDefs": [

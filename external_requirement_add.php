                        ...
                        <form name="step1" id="step1" role="form" method="post">
                          ...
                          <div class="form-group col-md-6">
                                    ...
                                    <label for="username">Requested Date From: </label>
                                        ...
                                        <input type='text' class="form-control date_pick repeatz" name="requirement[0][hiring_requirment_date_from]"
                                    ...
                                    <label for="username">Requested Date To: </label>
                                        ...
                                        <input type='text' class="form-control date_pick repeatz" name="requirement[0][hiring_requirment_date_to]"
...
if (count($select_job) > 0) {
				...
				+ '<input type="text" name="requirement[' + added_val + '][hiring_requirment_date_from]" class="form-control date_pick repeatz" onkeydown="return false" />'
                ...
                + '<div class="form-group col-md-6 ">'
                + '<label for="username">Requested Date To: </label>'
				+ '<input type="text" name="requirement[' + added_val + '][hiring_requirment_date_to]" class="form-control date_pick repeatz" onkeydown="return false" />'
                + '</div>'
                + '</div>'

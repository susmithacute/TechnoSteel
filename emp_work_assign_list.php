...
sm_employee.employee_lastname)as fullname, sm_employee.employee_employment_id,sm_work_assign_employee_id.employee_id 
 FROM sm_employee  LEFT JOIN sm_work_assign_employee_id ON 
 sm_employee.employee_id= sm_work_assign_employee_id.employee_id
 WHERE sm_work_assign_employee_id.employee_work_assign_id='$_REQUEST[work_assign_id]'");
if (count($resFet)) {
...
$fp = fopen('assets/extras/work_assign.json', 'w');
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <ul class="controls">
							<li>
 <a href="emp_work_assign_add.php" role="button" tabindex="0" class="tile-add" title="Add Employee Assignment">
...
<script>
    $(window).load(function () {
      ...
      var t=  $('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": 'assets/extras/work_assign.json',
            "order": [[1, "asc"]],
            "columns": [
                {
                    "data": null,
				...
				//{
                  ...
                  //  "render": function (data, type, full, meta) {
                   //     return '<a href="emp_work_assign_view.php?work_assign_id=' + full.employee_id + '" class=""><i class=""></i> ' + data + '</a>';
                   // }},
				{"data": "employee_employment_id"},
                {"data": "fullname"},
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "emp_work_assign_delete.php",
            type: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
                window.location = "emp_work_assign_list.php?work_assign_id=<?php echo $_REQUEST['work_assign_id']; ?>";
            }
        });
    });
</script>

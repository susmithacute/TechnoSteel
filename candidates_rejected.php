    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="rej_status" style="color: #080"></p>
            </div>
...
<script>
        ...
        var t = $('#products-list').DataTable({
            ...
            "columns": [
                ...
                {"data": "candidate_phone"},
                {
                    ...
                    "data": "company_id",
                    "render": function (data, type, full, meta) {
                        return '<a onclick="delete_id(' + full.candidate_id + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
    ...
    $('#sub_btn').click(function () {
        var hiddn = $('#hid_del').val();
        $.ajax({
            url: "candidate_list_process.php",
            type: "POST",
            data: {hiddn: hiddn},
            success: function (data) {
                $('#rej_status').html(data);
                location.href = "candidates_rejected.php";
            }
        });
    });
</script>

                            ...
                            <div class="tile-body p-0">
                                ...
                                <div role="tabpanel">
                                    ...
                                    <ul class="nav nav-tabs tabs-dark" role="tablist">
                                        <li role="presentation" ><a style="color:#16a085;" href="accounts_employee_travel_booked_profile.php?employee_id=<?php echo $_GET['employee_id']?>" >Profile</a></li>
										<li role="presentation"><a href="accounts_employee_travel_booked_edit.php?employee_id=<?php echo $_GET['employee_id']?>">Edit</a></li>

...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Interview List <span></span></h2>
...
<li>
 <a href="interview_add.php" role="button" tabindex="0" class="tile-add" title=" Add Interview">
...
<script>
            ...
            "columns": [
                ...
                {"data": "interview_auto_id"},
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return '<a href="interview_view.php?inter_id=' + full.interview_id + '" class="">' + data + '</a>';
                    }},
                {"data": "company_name"},
                {"data": "place"},
                {
                    ...
                    "data": "interview_id",
                    "render": function (data, type, full, meta) {
                        return '<a href="interview_edit.php?inter_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + full.interview_id + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
                    }}
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "interview_list_process.php",
            type: "POST",
            data: {interview_id: interview_id},
            success: function (data) {
                $('#candi_status').html(data);
                location.href = "interview.php";
            }
        });
    });
</script>

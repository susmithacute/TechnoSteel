...
$sub = "yearly_travel";
$sub1 = "accounts_employee_travel_cancel";
...
WHERE `travel_status` ='canceled' AND sm_employee_travel.travel_type_id='1'");
	 ...
	 function delete_id(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = "accounts_employee_travel_cancel.php";
            }
        });
    });

<?php
 $page = "accounts";
 $sub = "accounts_employee_appraisal";
                ...
                {"data": "employee_designation"},
				
				 {
                   ...
                   "render": function (data) {
                        return '<a href="accounts_employee_edit.php?uid=' + data + '&appraisal=1" class="btn btn-xs btn-blue" class="btn btn-xs btn-default mr-5"> Add Appraisal</a>';
                    }}
            ],
            "aoColumnDefs": [
...
$('#perform').on('change', function (e) { 
 //alert("dgfdg");
		...
		var year = jQuery('#year').val();
            ...
            location.href="accounts_employee_appraisal.php?year="+year+"&perform="+perform;
        //} 
    });
</script>

        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">Add Client</a>
                    </li>
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Add Client </a></li>
                    ...
                    <div class="tab-pane" id="tab1">
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="client_email">Client E-mail: </label>
                                    <input type="text" name="client_email" id="client_email" class="form-control" required>
                                    <span id="exist_status" class="validate_email validate_span"></span>
                                </div>
                            </div>
                            <div class="col-md-6">

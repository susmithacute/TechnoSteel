...
$resFet = $db->selectQuery("SELECT  com_pid,`com_name`, `year`, `month`,month_name, `sponser_fee`,`status`,`id` FROM `sm_sponser` where `sponsor_id`='" . $_SESSION['id'] . "' AND  month=$m and year=$y");

if (count($resFet)) {
    for ($rC = 0; $rC < count($resFet); $rC++) {
        $values['id'] = $resFet[$rC]['id'];
        $values['com_pid'] = $resFet[$rC]['com_pid'];
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2>Sponsorship Fee Status List<span></span></h2>
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="tables-bootstrap.html">Sponsorship Fee Status List</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Sponsorship Fee Status</strong> List</h1>
                            <ul class="controls">
                                <li class="dropdown">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group col-md-6 mb-0">
                    ...
                    <input type="text" name="dop" id="dop" placeholder="dd/mm/yyyy"/>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div style="font-size:25px;font-family:Ariel" class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h3 class="form-group col-md-6 mb-0">

                </h3>
                <input type="text" name="dop" id="dop" placeholder=""/>
            </div>
...
================================================ -->
<script>
    function ajax_fun(ids) {
        $.ajax({
            url: "sponser_ajax.php",
            type: "post",
            data: {ids: ids},
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = "sponsor_receive.php";
            }
        });
    });
</script>

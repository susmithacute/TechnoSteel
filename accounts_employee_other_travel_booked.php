...
WHERE sm_employee_travel.travel_type_id='2' AND `travel_status`='applied' AND (travel_departure_date > '$current_date')");
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a>Employee List - Travel Booked</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                           <h1 class="custom-font"><strong>Travel</strong>Booked</h1>
                            <ul class="controls">
							
							<li>
<a href="employee_other_travel.php" role="button" tabindex="0" class="tile-add" title="Add Other Travel Details">
...
<h3 class="modal-title custom-font">Sure To Cancel This Record ?</h3>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-default btn-border" id="sub_btn">Ok</button>
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
						 return '<a href="accounts_employee_other_travel_booked_profile.php?employee_id=' + full.employee_id + '" class=""><i class=""></i> ' + data + '</a>';
                    }},
                ...
                
                {
                    ...
                    return '<a href="accounts_employee_other_travel_booked_edit.php?employee_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a> <a onclick="delete_id(' + data + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i>Cancel</a>';
                    //return '<a href="partner_edit.php?id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>';
...
<script type="text/javascript">
    function delete_id(id)
    {
	   ...
	   $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "employee_travel_cancel_action.php" ,
            type: "POST",
            data: {employee_id: employee_id},
            success: function (data) {
               // alert(data);
                window.location =  'accounts_employee_other_travel_cancelled.php?employee_id='+ employee_id;
            }
        });

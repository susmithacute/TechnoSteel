...
if (count($resFet)) {
	...
	if(count($select)>0){
		...
		$values['visa_status'] = $select[0]['visa_status'];
...
<script type="text/javascript">
	...
	function candidate_id(id)
    {
	  ...
	  if(visa_date==''||visa_type==''||visa_category=='')
								{

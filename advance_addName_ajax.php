...
if(isset($_POST['designation'])){
   ...
   if (count($des_names) > 0)
    ...
    $employee_name=$db->selectQuery("SELECT CONCAT(sm_employee.employee_firstname,' ',sm_employee.employee_middlename,' ',sm_employee.employee_lastname)as fullname,employee_id,employee_company FROM `sm_employee` WHERE  `employee_designation`='$des_name' AND `employee_company`='$company_id'");

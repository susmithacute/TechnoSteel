    ...
    <div class="page page-gallery">
        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs tabs-dark" role="tablist">
                ...
                <li role="presentation" class="active"><a href="employee_gallery.php?uid=<?php echo $_GET['uid'] ?>" aria-controls="messages" role="col2" data-toggle="tab">Documents</a></li>				<li role="presentation"><a href="emp_leave_details.php?uid=<?php echo $_GET['uid'] ?>">Leave Details</a></li>
            </ul>
...
<script>
    function Redirect()
    {
        window.location = "accounts_employee_gallery.php?uid=" +<?php echo $id; ?>;
    }

...
if($_SERVER['REQUEST_METHOD']=='POST')
	{
			...
			$insert = $db->secure_insert("sm_bank_details", $values);
				if($insert){
					echo "sucess";
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Add Bank Details </a></li>
...
<!--/ Page Specific Scripts -->
	<script>
$('#bank_branch').on('blur', function (e) {
    var bank_branch = jQuery('#bank_branch').val(); 
    var bank_name = jQuery('#bank_name').val(); 	
    if(bank_branch != ""){
    $.ajax({
        url: 'bank_details_branchCheck.php',
        type: 'POST',
        dataType: 'json',
        data: {bank_branch: bank_branch,bank_name: bank_name},

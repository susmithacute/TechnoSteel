...
$agent_list = $db->selectQuery("SELECT  `agent_id`,`agent_company`,`agent_area_id`,`agent_country`,`agent_place` FROM `sm_recruitment_agents` where `agent_status`='0' ORDER BY agent_id DESC ");
if (count($agent_list )) {
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
					...
					<li>
                        <a href="javascript:void(0)">Agent Archive</a>
                    </li>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Agent Archive</h1>
                            <ul class="controls">
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "agent_restore.php",
            type: "POST",
            data: {pass_val: pass_val},
            success: function (data) {
                window.location = "agent_archive.php";
            }
        });
    });</script>

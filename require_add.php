        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                ...
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li><a href="#tab2" data-toggle="tab">Hiring Requirements<span
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="requirement[1][date_assign_from]"  class="form-control" onkeydown="return false" required=""/>
                    ...
                    <div class="form-group col-md-6">
						...
						<div class='input-group datepicker' data-format="L">
                        <input type="text" name="requirement[1][date_assign_to]"  class="form-control" onkeydown="return false" required=""/>
						<span class="input-group-addon"> <span class="fa fa-calendar"></span> 
                    </div>
					</div>
								...
								<div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="requirement[1][no_of_employees]"  class="form-control" data-parsley-trigger="change"
                                                       data-parsley-type="digits" required/>
                                </div>
                ...
                <div class="form-group col-md-6">
                        <label for="username">Date Assign From:</label>
						<div class='input-group datepicker' data-format="L">
                        <input type="text" name="requirement[2][date_assign_from]"  class="form-control" onkeydown="return false" required=""/>
						<span class="input-group-addon"> <span class="fa fa-calendar"></span> 
                    </div>
					</div>
                    ...
                    <div class="form-group col-md-6">
                        <label for="username">Date Assign To:</label>
						<div class='input-group datepicker' data-format="L">
                        <input type="text" name="requirement[2][date_assign_to]"  class="form-control" onkeydown="return false" required=""/>
						<span class="input-group-addon"> <span class="fa fa-calendar"></span>
                    </div>
					</div>
								...
								<div class="form-group col-md-6">
                                    <label for="username">No of employees required: </label>
                                    <input type="text" name="requirement[2][no_of_employees]"  class="form-control" data-parsley-trigger="change"
                                                       data-parsley-type="digits" required/>
                                </div>

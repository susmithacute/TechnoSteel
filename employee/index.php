...
<html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Sponsor Master - Admin Login</title>
        ...
        <div id="wrap" class="animsition">
            ...
            <div class="page page-core page-login">
                <div class="text-center"><b><h2 class="text-light text-white"><b>SPONSOR MASTER</b> </h2><b></div>
                            <div class="container w-420 p-15 mt-40 text-center" style="
                                ...
                                <h2 class="text-light text-white"><b>Login</b></h2>
            ...
            $(window).load(function () {
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = $db->selectQuery("SELECT * FROM `sm_employee_login` WHERE BINARY `employee_username`=BINARY '$b' AND BINARY `employee_password`= BINARY '$d'");
                                if (count($sql)) {
                                    $_SESSION['eid'] = $sql[0]['employee_id'];
                                    $a = $_SESSION['eid'];

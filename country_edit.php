...
?>
             <?php
                ...
                $res = $db->selectQuery("select * from sm_recruit_country where country_id='" . $_GET['country_id'] . "' ");
...
if (isset($_POST['submit'])) {
	...
	$query1 = $db->secure_update('sm_recruit_country', $values1, "  WHERE country_id = '" . $_GET['country_id'] . "'");
	if (count($query1)) {
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Edit Country </a></li>
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="country_name" value="<?php echo $country_name;?>" id="country_name" class="form-control" required>
                                    <span id="com_status" class="validate_span"></span>

                                </div>
                          </div>
						  <input type="hidden" name="edit_id" id="edit_id" value="<?php echo $country_id; ?>" />
						   <div class="col-md-6">
...
$('#country_name').on('blur', function (e) {
        var country_name = jQuery('#country_name').val();
		var edit_id = jQuery('#edit_id').val();
        $('#com_status').html('Please wait...');
        $.ajax({
            url: 'country_check_edit.php',
            type: 'POST',
            dataType: 'json',
            data: {country_name: country_name,edit_id:edit_id},

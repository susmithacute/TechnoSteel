...
$sub = "yearly_travel";
$sub1 = "accounts_employee_travel_booked";
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
						 return '<a href="accounts_employee_travel_booked_profile.php?employee_id=' + full.employee_id + '" class=""><i class=""></i> ' + data + '</a>';
                    }},
                ...
                
                {
                    ...
                    return '<a href="accounts_employee_travel_booked_edit.php?employee_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a> <a onclick="delete_id(' + data + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i>Cancel</a>';
	   ...
	   $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
               // alert(data);
                window.location =  'accounts_employee_travel_cancel.php?employee_id='+ employee_id;
            }
        });

                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Inhouse Requirement  List  <?php //echo $resFet[$rC]['id']; ?></strong></h1>
                            <ul class="controls">
							<li>
      ...
      var t=  $('#products-list').DataTable({
            ...
            "columns": [
                ...
                
                {
                    ...
                    "data": "id",
                    "render": function (data) {
                        return '<a href="inhouse_requirement_edit.php?uid=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-lightred" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i> Delete</a>&nbsp;&nbsp;<a href="main_requirement_list.php?id=' + data + '" class="btn btn-xs btn-green" data-toggle="modal"  > view</a>';
                    }},
...
<script type="text/javascript">
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            url: "inhouse_requirement_delete.php",
            type: "POST",

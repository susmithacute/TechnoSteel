    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = "hiring_requirment_list.php";
            }
        });
    });</script>

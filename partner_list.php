...
$resFet = $db->selectQuery("SELECT  `id`, `image`, `parid`, `compname`, `parname`, `phone`, `email` FROM `partner` where `custid`='" . $_SESSION['id'] . "' AND `status`='1' ORDER BY id DESC");
if (count($resFet)) {
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Sl.no</th>
                                            <th style="width:80px;" class="no-sort">Qatar ID</th>

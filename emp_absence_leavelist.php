...
$empArray = array();
$resFet = $db->selectQuery("SELECT CONCAT( sm_employee.employee_firstname,  ' ', sm_employee.employee_middlename,  ' ', sm_employee.employee_lastname ) AS full_name,sm_employee.employee_employment_id,sm_employee.employee_id,sm_employee_leave.reason,sm_employee_leave.leave_from,sm_employee_leave.leave_to,sm_employee_leave.leave_id  FROM sm_employee INNER JOIN sm_employee_leave ON sm_employee.employee_id= sm_employee_leave.employee_id WHERE sm_employee.employee_id=$uid AND sm_employee_leave.leave_type_id='5' AND sm_employee_leave.status='active'");
if (count($resFet)) {
...
$fp = fopen('assets/extras/absleave.json', 'w');
...
<section id="content">
    ...
    <div class="page page-shop-products">
      ...
      <div class="pageheader">
            ...
            <h2>Absence Leave <span> : <b><?php echo $fullname; ?></b></span></h2> 
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Absence Leave List</strong></h1>
                            <ul class="controls">
							<li>
...
<script>
    $(window).load(function () {
        ...
        var t =$('#products-list').DataTable({
            ...
            "pagingType": "input",
            "ajax": 'assets/extras/absleave.json',
            "order": [[1, "asc"]],
            "columns": [
                {
                    "data": "null",
    ...
    $('#sub_btn').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                window.location = "absence_leavelist.php?uid="+<?php echo $uid ?>;
            }
        });
    });
	</script>
    ...
    $('#sub_btn1').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                    ...
                    $(Succ).html("Added");
					location.href = "absence_leavelist.php?uid="+<?php echo $uid ?>;
                }
				else
				{
					 $(Succ).html("");

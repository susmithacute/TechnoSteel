...
$resFet = $db->selectQuery("SELECT  com_pid,`com_name`, `year`, `month`,month_name, `sponser_fee`,`status`,`id` FROM `sm_sponser` where `sponsor_id`='" . $_SESSION['id'] . "' AND `status`='unpaid' and month=$m and year=$y");
